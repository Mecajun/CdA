...
class Ui_Relatorios_Window(object):
    def setupUi(self, Relatorios_Window):
        ...
        self.widget.setGeometry(QtCore.QRect(10, 20, 181, 141))
        ...
        self.dateTimeEdit_inicial = QtGui.QDateTimeEdit(self.widget)
        ...
        self.dateTimeEdit_final = QtGui.QDateTimeEdit(self.widget)
        ...
        self.widget2.setGeometry(QtCore.QRect(10, 180, 421, 29))
        self.widget2.setObjectName("widget2")
        self.horizontalLayout = QtGui.QHBoxLayout(self.widget2)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.pushButton_log_porta = QtGui.QPushButton(self.widget2)
        ...
        self.pushButton_relatorio_pontos = QtGui.QPushButton(self.widget2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
