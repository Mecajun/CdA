...
# Form implementation generated from reading ui file 'funcionarios.ui'
#
# Created: Fri Jan 17 22:54:27 2014
#      by: pyside-uic 0.2.13 running on PySide 1.1.0
#
# WARNING! All changes made in this file will be lost!
...
class Ui_Add_Funcionarios_Window(object):
    def setupUi(self, Add_Funcionarios_Window):
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 674, 25))
        self.menubar.setObjectName("menubar")
        self.menuEditar_Funcionarios = QtGui.QMenu(self.menubar)
        self.menuEditar_Funcionarios.setObjectName("menuEditar_Funcionarios")
        self.menuRemover_Funcionarios = QtGui.QMenu(self.menubar)
        self.menuRemover_Funcionarios.setObjectName("menuRemover_Funcionarios")
        Add_Funcionarios_Window.setMenuBar(self.menubar)
        self.menubar.addAction(self.menuEditar_Funcionarios.menuAction())
        self.menubar.addAction(self.menuRemover_Funcionarios.menuAction())
    ...
    def retranslateUi(self, Add_Funcionarios_Window):
        ...
        self.pushButton_remover_horario.setText(QtGui.QApplication.translate("Add_Funcionarios_Window", "Remover Horario", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("Add_Funcionarios_Window", "Funcionarios Cadastrados", None, QtGui.QApplication.UnicodeUTF8))
        self.menuEditar_Funcionarios.setTitle(QtGui.QApplication.translate("Add_Funcionarios_Window", "Editar Funcionarios", None, QtGui.QApplication.UnicodeUTF8))
        self.menuRemover_Funcionarios.setTitle(QtGui.QApplication.translate("Add_Funcionarios_Window", "Remover Funcionarios", None, QtGui.QApplication.UnicodeUTF8))
