#!/usr/bin/env python
# -*- coding: utf-8 -*-
# generated by wxGlade 0.6.4 on Tue Aug 27 20:44:00 2013
...
class MainFrame(wx.Frame):
    ...
    def troca_Debug(self,text):
        print text.data
        self.label_debug.SetLabel(text.data)
...
class Frame(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.combo_box_datas_adm = wx.ComboBox(self.notebook_1_funcionarios, -1, choices=["Domingo","Segunda", u"Terça", "Quarta", "Quinta", "Sexta", "Sabado"], style=wx.CB_DROPDOWN)
    ...
    def button_Gerar_Relatorio(self, event):  # wxGlade: Frame.<event_handler>
        ...
        self.combo_box_datas_adm.GetCurrentSelection()
        event.Skip()
