...
class Connect_MySQL:
    ...
    def cria_tabelas(self):
        self.curs.execute("CREATE TABLE funcionarios (id_funcionario INT NOT NULL AUTO_INCREMENT PRIMARY KEY, matricula INT NOT NULL', rfid varchar(20))")
    ...
    def cria_funcionario(self,nome,rfid,horario,)
